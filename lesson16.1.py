class Rectangle:
    ...
    def __add__(self, other):
        if not isinstance(other, Rectangle):
            raise TypeError("Додавати можна лише прямокутник до прямокутника!")
    ...
    def __mul__(self, n):
        if not isinstance(n, (int, float)):
            raise TypeError("Прямокутник можна множити лише на число!")
...
r3 = r1 + r2
print(f"r3 після додавання: {r3}")
assert r3.get_square() == 26, "Test3"

r4 = r1 * 4
print(f"r4 після множення: {r4}")
